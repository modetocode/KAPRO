    ...
    public partial class KinectSensorChooser : UserControl
    {
        ...
        public KinectSensorChooser()
        {
            ...
            this.UpdateMessage(
                ...
                "Потребен е Кинект",
                "За да работи апликацијата, потребен е Kinect. Ве молиме поврзете еден Kinect со компјутерот",
        ...
        private void UpdateStatus(KinectStatus status)
        {
            ...
            switch (status)
            {
                case KinectStatus.Connected:
                    ...
                    {
                        message = "Кинектот се користи од друга апликација.";
                ...
                case KinectStatus.Initializing:
                    message = "Иницијализација на сензорот...";
                    moreInfo = null;
                    moreInfoUri = null;
                    break;
