...
namespace Markov
{
    public partial class MainForm : Form
    {
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            //public MarkovSequenceClassifier(int classes, String[] names,String[] filePath)
            //String[] filePath = { @"D:\HMM\HMMramnoto parameters.txt", @"D:\HMM\HMM6n3n parameters.txt" };
            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm improved v2\6n3n_currentHMM.txt" };

            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm real-time\pajdusko_currentHMM.txt" };
            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm real-time\6n3n_currentHMM.txt" };
            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm real-time\ramnoto_currentHMM.txt" };
            
            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm centroids\ramnoto_currentHMM.txt" };
            //String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm centroids\o6n3n_currentHMM.txt" };
            String[] filePath = { @"C:\Users\DarkoLaptop2\Dropbox\Magisterska\calculations\hmm centroids\pajdusko_currentHMM.txt" };
            
            hmmc = new MarkovSequenceClassifier(classes, categories, filePath);
            //hmmc = new MarkovSequenceClassifier(classes, 7, states, categories);
